...
void Lied::eintraganzeigen(vector<Lied>& liste, Lied li){
    ...
    cin >> eintragsnr;
        ...
        if (liste[eintragsnr - 1].g == pop) {
            cout << "Genre: Pop" << endl << endl;  
        }
        
        if (liste[eintragsnr - 1].g == rock) {
            cout << "Genre: Rock" << endl << endl;
        }
        
        if (liste[eintragsnr - 1].g == klassik) {
            cout << "Genre: Klassik" << endl << endl;
        }
        
        if (liste[eintragsnr - 1].g == hard_rock) {
...
void Lied::eintragbearbeiten(vector<Lied>& liste, Lied li){
    ...
    cin >> bearbeiten;
        ...
        cout << "Titel: " << liste[bearbeiten - 1].titel << endl;
        cout << "Interpret: " <<liste[bearbeiten - 1].interpret << endl;
        cout << "Erscheinungsjahr: " << liste[bearbeiten - 1].erscheinungsjahr << endl;
        cout << "Laenge: " << liste[bearbeiten - 1].laenge << endl;
        ...
        if (information == "interpret" | information == "Interpret") {
            ...
            cin >> interpret;
            liste[bearbeiten - 1].interpret = "Interpret: " + interpret;
        }
